...
**Current version:** v2.3.3 (Max-Mode default — lightning-speed shipping).
**Status:** single-host, single-queen production-ish. Max-Mode is now the default colony profile (24-shard concurrency cap, sample-rate gate-rerun, single-review). Cross-host signaling via [`claude-mesh`](https://github.com/umitkacar/claude-mesh); multi-host fencing remains v3.
